...
export const Hero = () => {
  return (
    <main className="bg-background relative mt-[52px] flex w-full flex-col items-center justify-center overflow-clip border-b border-dashed pt-12 antialiased">
      <OrbitingCirclesWrapper />
      <div className="container relative z-20 flex w-full flex-col items-center gap-6 px-4 py-32 text-center sm:gap-8">
